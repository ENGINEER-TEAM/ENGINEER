...
SUDO = SUDO
sudo_users = {SUDO,989254692,1033028167}   
print([[
> CH › @AELOT_10
> CH › @JJ_22_l
~> DEVELOPER › @ZAINAELOT
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ENGINEER-TEAM/Files_ENGINEER/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevENGINEERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(989254692) then  
var = true  
...
local UserName = (data.username_ or "AELOT_10")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@ZAINAELOT")  
...
--------------------------------------------------------------------------------------------------------------
function SourceENGINEER(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if not DevENGINEERW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevENGINEERW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌁' and DevENGINEERW(msg) then  
...
if text == 'تعطيل التواصل ⌁' and DevENGINEERW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌁' and DevENGINEERW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌁' and DevENGINEERW(msg) then  
...
if text == 'ضع كليشه ستارت ⌁' and DevENGINEERW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌁︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌁' and DevENGINEERW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌁︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌁' and DevENGINEERW(msg) then 
...
if text == 'تحديث السورس ⌁' and DevENGINEERW(msg) then 
os.execute('rm -rf ENGINEER.lua')
os.execute('wget https://raw.githubusercontent.com/ENGINEER-TEAM/ENGINEER/main/ENGINEER.lua')
send(msg.chat_id_, msg.id_,' *⌁︙تم تحديث السورس* \n*⌁︙لديك اخر اصدار لسورس المهندسين*\n*⌁︙الاصدار » { 2.8v}*')
dofile('ENGINEER.lua')  
end
if text == 'الاصدار ⌁' and DevENGINEERW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌁︙اصدار سورس المهندسين* \n*⌁︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌁' and DevENGINEERW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁︙[تحديثات البوت](t.me/JJ_22_l) \n⌁︙[قناه السورس](t.me/AELOT_10)')
end
if text == "ضع اسم للبوت ⌁" and DevENGINEERW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌁' and DevENGINEERW(msg) then 
...
if text == 'المشتركين ⌁' and DevENGINEERW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌁︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁' and DevENGINEERW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌁︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁") and DevENGINEERW(msg) then
...
if text == ("قائمه العام ⌁") and DevENGINEERW(msg) then
...
if text == ("قائمه الكتم العام ⌁") and DevENGINEERW(msg) then
...
if text=="اذاعه خاص ⌁" and msg.reply_to_message_id_ == 0 and DevENGINEERW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل الان اذاعتك؟* \n*⌁︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌁" and msg.reply_to_message_id_ == 0 and DevENGINEERW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل الان اذاعتك؟* \n*⌁︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌁" and msg.reply_to_message_id_ == 0 and DevENGINEERW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل الان اذاعتك؟* \n*⌁︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌁" and msg.reply_to_message_id_ == 0  and DevENGINEERW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌁︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁" and msg.reply_to_message_id_ == 0  and DevENGINEERW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁' and DevENGINEERW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁" and DevENGINEERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌁" and DevENGINEERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevENGINEERW(msg) then
...
usertext = '*\n ⌁︙العضو »* ['..result.title_..'](t.me/'..(username or 'AELOT_10')..')'
status  = '\n *⌁︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevENGINEERW(msg) then
...
usertext = '\n *⌁︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'AELOT_10')..')'
status  = '\n*⌁︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevENGINEERW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevENGINEERW(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌁︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'AELOT_10')..') \n ⌁︙'..ENGINEER1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *⌁︙العضو :* {["..data.first_name_.."](T.ME/AELOT_10)}\n⌁︙["..ENGINEER_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌁︙عذرا »* {["..data.first_name_.."](T.ME/AELOT_10)}\n*⌁︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevENGINEERW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevENGINEERW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevENGINEERW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌁︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevENGINEERW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌁︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌁" and DevENGINEERW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌁︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁$") and DevENGINEERW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌁︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁" and DevENGINEERW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌁" and DevENGINEERW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌁︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌁" and DevENGINEERW(msg) then  
...
if t2.id_ then 
name_ENGINEER = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ENGINEER then 
names_ENGINEER = database:smembers(bot_id.."ENGINEER:blocname"..msg.chat_id_) or ""
if names_ENGINEER and names_ENGINEER[1] then 
for i=1,#names_ENGINEER do 
if name_ENGINEER:match("(.*)("..names_ENGINEER[i]..")(.*)") then 
...
function amir_ENGINEERa_new(ENGINEER1,ENGINEER2)
if ENGINEER2 and ENGINEER2.first_name_ then 
if ENGINEER2.first_name_:match("(.*)"..database:get(bot_id.."ENGINEER:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ENGINEER:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ENGINEER_nnn = database:get(bot_id.."ENGINEER:nump"..msg.chat_id_) or 5
local ENGINEER_nnn2 = database:get(bot_id.."ENGINEER:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ENGINEER_nnn2) == tonumber(ENGINEER_nnn) or tonumber(ENGINEER_nnn2) > tonumber(ENGINEER_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ENGINEER:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عزيزي >>["..ENGINEER2.username_.."](https://t.me/"..(ENGINEER2.username_ or "AELOT_10")..")\n⌁︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ENGINEER:teh"..msg.chat_id_).."} بجانب اسمك\n⌁︙عدد المحاولات المتبقيه {"..(tonumber(ENGINEER_nnn) - tonumber(ENGINEER_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ENGINEERa_new)
end
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴇɴɢɪɴᴇᴇʀ\n\n[⌁  ᴇɴɢɪɴᴇᴇʀ ᴄʜᴀɴɴᴇʟ](http://t.me/JJ_22_l)\n\n[⌁  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/AELOT_10)\n\n[⌁  ᴇɴɢɪɴᴇᴇʀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/ZAINAELOT)\n\n[⌁  ʙᴏᴛ ᴇɴɢɪɴᴇᴇʀ](http://t.me/eengineerbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌁ sᴏᴜʀᴄʀ ᴇɴɢɪɴᴇᴇʀ',url="t.me/JJ_22_l/11"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/JJ_22_l&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevENGINEERW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌁︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'AELOT_10')..') \n*⌁︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌁︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'AELOT_10')..') \n*⌁︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevENGINEERW(msg) then
dofile('ENGINEER.lua')  
send(msg.chat_id_, msg.id_, ' *⌁︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevENGINEERW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevENGINEERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if ENGINEERSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevENGINEERW(msg) then
...
if ENGINEERSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevENGINEERW(msg) then
...
if ENGINEERSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevENGINEERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevENGINEERW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevENGINEERW(msg) then
...
if ENGINEERSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌁︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevENGINEERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevENGINEERW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevENGINEERW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevENGINEERW(msg) then
...
if text == 'الملفات' and DevENGINEERW(msg) then
t = ' *⌁︙ملفات السورس المهندسين ↓*\n*•━━━━━━ 𝙀𝙂𝙍 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevENGINEERW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ENGINEER-TEAM/Files_ENGINEER/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌁︙اهلا بك في متجر ملفات المهندسين*\n*⌁︙ملفات السورس ↓*\n*•━━━━━━ 𝙀𝙂𝙍 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙀𝙂𝙍 ━━━━━━━•*\n *⌁︙علامة تعني { ✓ } ملف مفعل*\n *⌁︙علامة تعني { ✘ } ملف معطل*\n *⌁︙قناة سورس المهندسين ↓*\n".." *⌁︙*[اضغط هنا لدخول](t.me/AELOT_10) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevENGINEERW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ENGINEER-TEAM/Files_ENGINEER/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ENGINEER.lua')  
else
send(msg.chat_id_, msg.id_," *⌁︙عذرا الملف لايدعم سورس المهندسين* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevENGINEERW(msg) then
...
if text == "مسح الملفات" and DevENGINEERW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌁︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevENGINEERW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevENGINEERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "AELOT_10")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌁︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'AELOT_10')..')'
status  = '\n*⌁︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌁︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌁︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'AELOT_10')..')'
...
if text == 'مسح كليشه المطور' and DevENGINEERW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌁︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevENGINEERW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌁︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'AELOT_10')..')'..'\n*⌁︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevENGINEERW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevENGINEERW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'المهندسين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'المهندسين')
local ENGINEER_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
if database:get(bot_id..'Bc:Bots') and not DevENGINEERW(msg) then 
...
if ENGINEERSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevENGINEERW(msg) then 
...
if text == ("ردود المطور") and DevENGINEERW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌁︙قائمة ردود المطور \n*•━━━━━━ 𝙀𝙂𝙍 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevENGINEERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevENGINEERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'المهندسين').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevENGINEERW(msg) then   
...
if text == 'تعطيل المغادره' and DevENGINEERW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌁︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ENGINEER')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'AELOT_10')..')'
local iduser = result.sender_user_id_
...
if text == 'استعاده الاوامر' and DevENGINEERW(msg) then
...
*⌁م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ 𝙀𝙂𝙍 ━━━━━━━•*ٴ
[⌁ 𝙀 ɴ 𝙂 ɪ 𝐍 𝙴 𝙴 𝙍 𝑇𝐸𝐴𝑀 ](t.me/AELOT_10) 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ⌁∫ٴ*•━━━━━━ 𝙀𝙂𝙍 ━━━━━━━•*ٴ⌁∫○ٴ\n⌁︙[⌁ 𝙀 ɴ 𝙂 ɪ 𝐍 𝙴 𝙴 𝙍 𝑇𝐸𝐴𝑀](t.me/AELOT_10) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌁ 𝙀 ɴ 𝙂 ɪ 𝐍 𝙴 𝙴 𝙍 𝑇𝐸𝐴𝑀.',url="t.me/JJ_22_l"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'المهندسين')
